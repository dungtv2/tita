...
//                    self.render_fields_show();
        ...
        render_fields_show: function () {
            ...
            if (this.fields_view.type == 'tree' && typeof(this.result) != 'undefined'){
                ...
                QWeb.add_template("/show_sequence_columns_easy_ma_mi_la_ti_ta/static/src/xml/my_control.xml");
...
openerp.show_sequence_columns_easy_ma_mi_la_ti = function(instance) {
